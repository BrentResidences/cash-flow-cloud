...
def quick_budget_report_pdf_bytes(report_start, report_end, detail_df, weekly_df, summary_df):
    lines = []
...
with tab9:
    ...
    if quick_report_end < quick_report_start:
        ...
        if quick_detail.empty:
            ...
            st.markdown("#### Project / Forecast Summary")
        ...
        st.caption("These downloads use the selected report date range. If no entries are found, the PDF will state that no quick budget entries were found.")

        quick_report_excel = to_excel_bytes({
            "Quick Budget Weekly": quick_weekly.copy(),
            "Quick Budget Summary": quick_summary.copy(),
            "Quick Budget Detail": quick_detail.copy(),
        })
        st.download_button(
        ...
        quick_report_pdf = quick_budget_report_pdf_bytes(quick_report_start, quick_report_end, quick_detail, quick_weekly, quick_summary)
        st.download_button(
