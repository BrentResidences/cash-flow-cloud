...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9 = st.tabs(["Dashboard", "Companies", "Funding", "Projects / Work Groups", "Labor", "Materials and Other Costs", "6-Month Weekly Cash Flow", "Reports / Import / Export", "User Access"])
